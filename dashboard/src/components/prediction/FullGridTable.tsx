...
export function FullGridTable({ predictions, season, round }: Props) {
  ...
  return (
    ...
    >
      ...
      <ModelNote
        text={`Predictions generated by ${modelLabel} · Confidence scores represent the model's probability estimate for each driver finishing in the stated position · Updated 4h before lights out`}
        variant="zap"
      />
    </motion.div>
  );
